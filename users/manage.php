...
$sql = "SELECT u.*, up.first_name, up.last_name, up.profile_image, up.whatsapp_number,
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                    <div class="mt-1">
                                        <a href="<?php echo $whatsappUrl; ?>" target="_blank" class="text-decoration-none" title="Open WhatsApp chat">
                                            <i class="fab fa-whatsapp text-success me-1"></i>
                                            <small><?php echo htmlspecialchars($user['whatsapp_number']); ?></small>
                                        </a>
                                    </div>
                                <?php endif; ?>
                                <?php if (!empty($user['user_identifier'])): ?>
                                    <small class="text-muted d-block mt-1">
                                        ...
                                        <?php echo htmlspecialchars($user['user_identifier']); ?>
                                    </small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <strong class="text-primary"><?php echo formatCurrency($user['wallet_balance'] ?? 0); ?></strong>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="<?php echo BASE_URL; ?>/admin/users/view.php?id=<?php echo $user['id']; ?>" 
                                    ...
                                    <a href="mailto:<?php echo htmlspecialchars($user['email']); ?>" 
                                       class="btn btn-outline-secondary" title="Email">
