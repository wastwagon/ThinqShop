    <!-- Premium World-Class Footer -->
    <link rel="stylesheet" href="<?php echo asset('assets/css/premium-footer.css'); ?>?v=<?php echo time(); ?>">
                                ...
                                <form action="<?php echo BASE_URL; ?>/modules/ecommerce/cart/add.php" method="POST" id="quickViewForm">
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        <div class="d-flex gap-2">
                                            <button type="button" class="btn btn-outline-danger flex-fill" onclick="toggleWishlist(${product.id})" title="Add to Wishlist">
    ...
    <!-- Premium Footer already includes mobile view -->
